...
unzip -qq ~/download/eclipse-SDK-3.3.2-win32.zip
mv eclipse eclipse-SDK-3.3.2-win32
...
tar -xzf ~/download/eclipse-SDK-3.3.2-linux-gtk.tar.gz
mv eclipse eclipse-SDK-3.3.2-linux-gtk

tar -xzf ~/download/eclipse-jee-ganymede-linux-gtk.tar.gz
mv eclipse eclipse-jee-ganymede-linux-gtk

tar -xzf ~/download/eclipse-jee-ganymede-SR1-linux-gtk.tar.gz
mv eclipse eclipse-jee-ganymede-SR1-linux-gtk
