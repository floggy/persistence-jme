...
public class FR2852335MigrationTest extends FloggyBaseTest {
	...
	*/
	public void testFindUpdatedToAbstractJoinedClass() {
		...
		assertEquals(PersistableMetadata.PER_CLASS_STRATEGY,
			classBasedMetadata.getPersistableStrategy());

		try {
			manager.find(CSCOfAbstractJoinedStrategy.class, null, null);
			fail(
				"Must throw a FloggyException because now the class implements the PerClassStrategy startegy");
		} catch (Exception ex) {
	...
	* @throws Exception DOCUMENT ME!
	*/
	public void testMigrationConcreteSubClassOfConcreteSubClass()
		throws Exception {
		MigrationManager mm = MigrationManager.getInstance();
	...
	* @throws Exception DOCUMENT ME!
	*/
	public void testMigrationConcreteSubClassOfConcreteSuperClass()
		throws Exception {
		MigrationManager mm = MigrationManager.getInstance();
	...
	*/
	protected void setUp() throws Exception {
		...
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/FloggyProperties.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/FloggyProperties.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/CSCOfAbstractSuperClass-11335278.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/CSCOfAbstractSuperClass-11335278.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/CSCOfConcreteSuperClass-21101282.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/CSCOfConcreteSuperClass-21101282.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/CSCOfConcreteSubClass1826896726.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/CSCOfConcreteSubClass1826896726.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/ConcreteSuperClass-766888397.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/ConcreteSuperClass-766888397.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/AbstractJoinedStrategy373328175.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/AbstractJoinedStrategy373328175.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/CSCOfAbstractJoinedStrategy12600.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/CSCOfAbstractJoinedStrategy12600.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/ConcreteJoinedStrategy-184426436.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/ConcreteJoinedStrategy-184426436.rms"));
		IOUtils.copy(new FileInputStream(
				"src/test/rms/1.4.0/perclass/CSCOfConcreteJoinedStrategy-9575.rms"),
			new FileOutputStream(
				"target/fr2852335/rms/1.4.0/perclass/CSCOfConcreteJoinedStrategy-9575.rms"));
		MIDletBridge.setMicroEmulator(new RMSMemoryMicroEmulator(
				"target/fr2852335/rms/1.4.0/perclass"));
