...
public class CodeGenerator {
	...
	CtField id = CtField.make(buffer, ctClass);
	if (generateSource) {
	...
	// RecordStore
	buffer
		.append("javax.microedition.rms.RecordStore rs = net.sourceforge.floggy.persistence.PersistableManager.getRecordStore(\""
	...
	CtMethod saveMethod = CtNewMethod.make(buffer.toString(), ctClass);
