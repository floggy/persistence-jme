...
public class SuperClassGenerator {
	...
	*/
	public static String generateLoadSource(CtClass superClass) {
		String source = "\n";
		source += ("javax.microedition.rms.RecordStore superRS = net.sourceforge.floggy.persistence.impl.RecordStoreManager.getRecordStore(super.getRecordStoreName(), net.sourceforge.floggy.persistence.impl.PersistableMetadataManager.getClassBasedMetadata(\""
		 + superClass.getName() + "\"));\n");
